...
//  WebCanvasDemo
//
//  Drawing routines adapted from Silica's SilicaTestSupport TestStyleKit
//  (PaintCode-generated), the same content exercised by SilicaCairoTests'
//  StyleKitTests, minus the network-fetched PNG assets.
//
